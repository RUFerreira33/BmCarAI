...
let AiController = class AiController {
    ...
    async recomendar(body) {
        return this.aiService.recomendar(body.mensagem);
    }
};
exports.AiController = AiController;
__decorate([
    (0, common_1.Post)('interpretar'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [chat_message_dto_1.ChatMessageDto]),
    __metadata("design:returntype", Promise)
], AiController.prototype, "interpretar", null);
__decorate([
    (0, common_1.Post)('recomendar'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [chat_message_dto_1.ChatMessageDto]),
    __metadata("design:returntype", Promise)
], AiController.prototype, "recomendar", null);
